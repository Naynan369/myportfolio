        ...
        <div className='w-full'>
            ...
            <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
                <div className='col-span-4'>
                    <p>Project</p>
                    <h2>Overview</h2>
                    <p>This simple calculator app project is build using common frontend softwares like Javascript, CSS3 and HTML5.</p>
                    <a
                        href='https://naynan369.github.io/calculator/'
                    >
                        <button className='px-8 py-2 mt-4 mr-8'>Demo</button>
                    </a>
                    <a href="https://github.com/Naynan369/calculator">
